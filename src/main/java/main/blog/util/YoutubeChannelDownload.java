...
public class YoutubeChannelDownload {
    private static final String CLIENT_SECRETS= "/json/client_secret_705831956629-d64.json";
    ...
    public Credential authorize(final NetHttpTransport httpTransport) throws IOException {
        // Load client secrets.
        File file = ResourceUtils.getFile("classpath:static" + CLIENT_SECRETS);

        // 파일로부터 InputStream을 생성합니다.
        InputStream in = new FileInputStream(file);
        //InputStream in = YoutubeUploadUtil.class.getClassLoader().getResourceAsStream(CLIENT_SECRETS);
    ...
    public void createVideo()
        ...
        video.getSnippet().setTitle("Dummy Title2");
        video.getSnippet().setDescription("Dummy Description2");
        video.setStatus(new VideoStatus());
        video.getStatus().setPrivacyStatus("public"); // Set privacy status (optional)
        ...
        Video response = request.setAutoLevels(true)
                ...
                //.setOnBehalfOfContentOwner("jaehyeok")
                //.setOnBehalfOfContentOwnerChannel("jaehyeok2")
                .setStabilize(true)
                .execute();
